...
TARGET   = snake
SRCS     = src/main.cpp src/Map.cpp src/Snake.cpp src/Item.cpp src/Gate.cpp src/ScoreBoard.cpp src/GameController.cpp src/RankingManager.cpp src/BlockWall.cpp
OBJS     = $(SRCS:.cpp=.o)
